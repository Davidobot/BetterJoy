    ...
    public class Joycon {
        ...
        private int ProcessButtonsAndStick(byte[] report_buf) {
            ...
            if (!isSnes) {
                ...
                ushort[] cal = form.useOriginalStickCalibration ? stick_cal : new ushort[6] { 2048, 2048, 2048, 2048, 2048, 2048 };
                ushort dz = form.useOriginalStickCalibration ? deadzone : (ushort)200;
