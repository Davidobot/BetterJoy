...
* Controller, touch, PlayStation, and Xbox button glyphs in the bindings interface are from
...
* Keyboard and media prompts are from
  [Mr. Breakfast's Free Prompts](https://github.com/mr-breakfast/mrbreakfasts_free_prompts) by
  Mr. Breakfast (CC0-1.0), imported unmodified; its bundled Xbox prompts were superseded by Kenney's
  Xbox Series glyphs. Source revision and the full checksum manifest are
